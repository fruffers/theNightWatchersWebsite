...
<?
if(!isset($a){
$link = @mysql_connect("sql207.infinityfreeapp.com", "epiz_20905967", "ET6zHANOpTD9"); 
if(!$link){
   echo('Error connecting to the database: '
   exit();
}
$db = @mysql_selectdb('newsDB');
if(!$db){
...
$query = "UPDATE news SET name = '$name, headline = '$headline', story = '$story', timestamp = NOW() WHERE id = '$id';
$result = @mysql_query($query);
if(!$result){
