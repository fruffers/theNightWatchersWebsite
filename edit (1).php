...
function renderForm($id, $daydate, $author, $title, $body, $error) //this is a function with parameters
...
<td><strong>Date: </strong></td> 
	<td><input type="date" name="daydate" value="<?php echo $daydate; ?>" /><td>
	<tr>
<p>* required</p>
	<tr>
...
renderForm($id, $firstname, $lastname, $error); //plug parameters into function
...
mysql_query("UPDATE news SET author='$author', title='$title', body='$body', daydate='$daydate' WHERE id='$id'") //WHERE makes sure that only the existing entry is edited by using its $id. 
...
renderForm($id, $daydate, $author, $title, $body, ''); //error is empty
